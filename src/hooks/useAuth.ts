...
export type UserRole = 'super_admin' | 'agente' | 'supervisore_segreteria' | 'segnalatore' | 'consulente' | null;
...
export function useAuth() {
  ...
  return {
    ...
    isSuperAdmin, isAgente, isSegreteria, isSegnalatore, isConsulente,
